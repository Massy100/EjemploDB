...
import Manejadores.Modelos;
import Manejadores.Querys;
...
public class Tablas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("EXAMENES", jScrollPane2);
        ...
        jTabbedPane1.addTab("PRACTICAS", jScrollPane3);
        ...
        jTabbedPane1.addTab("PROFESORES", jScrollPane4);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        modelador.obtenerDatos(alumnosTable, Querys.SELECT_ALUMNOS, Modelos.MODELO_ALUMNO);
        modelador.obtenerDatos(examenesTable, Querys.SELECT_EXAMENES, Modelos.MODELO_EXAMEN);
        modelador.obtenerDatos(practicasTable, Querys.SELECT_PRACTICAS, Modelos.MODELO_PRACTICA);
        modelador.obtenerDatos(profesoresTable, Querys.SELECT_PROFESORES, Modelos.MODELO_PROFESOR);
